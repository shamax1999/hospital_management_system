	...
	<body>
        ...
        <div class="navbar navbar-top navbar-inverse">
            ...
            <div class="navbar-inner">
                <div class="container-fluid">
                    <a class="brand" href="<?php echo base_url("home");?>"><?php echo $system_name;?></a>
        ...
        <div class="container">   
            ...
            <div class="span4 offset4">
                <div class="padded">
                    <center>
                        <img src="<?php echo base_url();?>uploads/logo1.png" style="height:125px;" /> 
                        <b><h2>Medicare Hospital </h2></b>
                        	...
                        	<?php echo form_open('login' , array('class' => 'separate-sections'));?>
                                <div class="">
                                    ...
                                    <select class="validate[required]" name="login_type" style="width:100%;">
                                        <option value=""><?php echo (' Select Your Account Type ');?></option>
